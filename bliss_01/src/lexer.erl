...
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(30, Ics, Line, Tlen+1, 8, Tlen);
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 38 ->
    yystate(30, Ics, Line, Tlen+1, 8, Tlen);
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 42, C =< 47 ->
    yystate(30, Ics, Line, Tlen+1, 8, Tlen);
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 64 ->
    yystate(30, Ics, Line, Tlen+1, 8, Tlen);
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 94, C =< 96 ->
    yystate(30, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
...
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 59, C =< 64 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 101 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 115 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 122 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 123 ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
...
yystate(26, [10|Ics], Line, Tlen, _, _) ->
    yystate(26, Ics, Line+1, Tlen+1, 13, Tlen);
...
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 38 ->
    yystate(30, Ics, Line, Tlen+1, 7, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 42, C =< 44 ->
    yystate(30, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(24, [45|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(23, [95|Ics], Line, Tlen, _, _) ->
    yystate(23, Ics, Line, Tlen+1, 7, Tlen);
yystate(23, [94|Ics], Line, Tlen, _, _) ->
    yystate(30, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 38 ->
    yystate(30, Ics, Line, Tlen+1, 7, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 42, C =< 44 ->
    yystate(30, Ics, Line, Tlen+1, 7, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 64 ->
    yystate(30, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 64 ->
    yystate(30, Ics, Line, Tlen+1, 8, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 94, C =< 96 ->
    yystate(30, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(20, [45|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(19, [45|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(22, Ics, Line, Tlen+1, 6, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 35 ->
    yystate(22, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(16, [45|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(12, [45|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line, Tlen+1, 3, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(19, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(10, [45|Ics], Line, Tlen, Action, Alen) ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 58 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
...
yystate(8, [45|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(5, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(5, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 40 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(5, [C|Ics], Line, Tlen, Action, Alen) when C >= 43 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
...
yystate(4, [45|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(2, Ics, Line, Tlen, _, _) ->
    {0,Tlen,Ics,Line};
yystate(1, [42|Ics], Line, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [10|Ics], Line, Tlen, Action, Alen) ->
    yystate(6, Ics, Line+1, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 40 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 43 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
...
yystate(0, [45|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 58 ->
    yystate(19, Ics, Line, Tlen+1, 7, Tlen);
...
yyaction_5(TokenChars, TokenLine) ->
     { token, { char, TokenLine, unquote (TokenChars) } } .
...
yyaction_7(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, list_to_atom (atomize (TokenChars)) } } .
